...
func dataPlaylistHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/playlist.html", size: 2928, mode: os.FileMode(420), modTime: time.Unix(1474037812, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
